                    ...
                    <GlassCard className="p-4 shadow-strong">
                        ...
                        <nav className="space-y-1">
                            <Link
                                ...
                                className="flex text-foreground items-center gap-3 px-3 py-2 rounded-lg text-muted-foreground hover:text-black hover:bg-white transition-all duration-200 font-bold"
                            >
